...
import { SpoonacularRecipeInstructions, SpoonacularRecipeInformation, getRecipeInformation, SpoonacularIngredientList, SpoonacularExtendedIngredientList, getRecipeInstructions, SpoonacularRecipeStep } from "../../services/apiService";
...
const IngredientList = ({ ingredients }: { ingredients: SpoonacularExtendedIngredientList }) => {
